-- Bi-Heyting lattice structure on type slices ⌊τ⌋: meets, joins, top, bottom, and Heyting/
-- co-Heyting (relative pseudo-)complements, mechanising Theorem 4.6 (thm:slice-lattices).
-- Dissertation: §4.2 Lattice Properties.
